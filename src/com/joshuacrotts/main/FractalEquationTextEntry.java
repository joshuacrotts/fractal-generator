...
public class FractalEquationTextEntry extends JTextField implements ActionListener {
  ...
  /**
   * Retrieves the text when the user presses enter, and parses
   * the equation.
   * 
   * @param ActionEvent e
   */
  ...
  /**
   * Parses an equation of the form z^2 + c, where c
   * is in the form a + bi. If there is no complex constant,
   * it is evaluated as the mandelbrot constant in the 
   * algorithm.
   * 
   * @param String equation.
   * @throws IllegalArgumentException if the equation is not in the format 
   *         of the regex.
   */
